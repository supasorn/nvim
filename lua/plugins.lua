...
return packer.startup(function(use)
  ...
  use {'brenoprata10/nvim-highlight-colors',
    opt = true,
    setup = function()
      require("utils").on_file_open "nvim-highlight-colors"
    end,
    config = function()
  ...
  --
  --     vim.cmd [[
  --       function! SpecsCustomHighlight()
  --         highlight specs guifg=#181a1f guibg=#c678dd
  --       endfunction
  --
  --       augroup SpecsCustomHighlight
  --         autocmd!
  --         autocmd ColorScheme * call SpecsCustomHighlight()
  --       augroup END
  --       call SpecsCustomHighlight()
  --     ]]
  --   end
  -- }
